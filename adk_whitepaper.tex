...
Monero\footnote{http://monero.org/} and Bytecoin\footnote{https://bytecoin.org/}
...
The IOTA team have stated that network corruption could arise if \( 2/3 \) of the total nodes in the network are controlled by bad 
actors. If we follow the confirmation process as outlined in IOTA's whitepaper, which counts only the number of referring transactions 
